...
const FormField: React.FC<FormFieldProps> = ({
  ...
  return (
    <View style={styles.fieldContainer}>
      {/* Label */}
      <Text style={styles.label} accessibilityRole="text" nativeID={`${label}-label`}>
        {label}
      ...
      {/* Error message */}
      {error && (
        <View style={styles.errorContainer} accessibilityRole="alert" accessibilityLive="polite">
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <TouchableOpacity
          style={[styles.button, (isSubmitting || hasErrors) && styles.buttonDisabled]}

...
- **Created**: 2026-05-20
- **Implements**: `.specify/feature-specs/stage-3/stage-3-roadmap.md` §Block A 第二项；roadmap 写了但 Block A 实施时只做了 Tushare + AKShare，本 spec 收口
...
```bash
pnpm ctx:feature coingecko-adapter
```

Config: `.specify/feature-specs/stage-3/coingecko-adapter.repomix.json`

...
| Field                 | Value                                                                                                                                                                                                                                                                          |
| :-------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Active stage**      | **Stage 3 — Insights 功能层面 ready** ✅（Enrichment + IA 四类重构 + 环形交互 + 3 个 Delta 风格详情页：trade-stats / risk / asset-value）→ **下一步 = 纯 UI/UX 微调 + 真机 UAT（Skia 图表/手势）**。Block F（CSV 进出 + 离线缓存）此前已 push。                                |
...
| **Last commit**       | `c1d70de` `feat(mobile): cache lifecycle on logout / env switch (AC.OF.9)`                                                                                                                                                                                                     |

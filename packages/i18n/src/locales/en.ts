export const en = {
  ...
  transaction: {
    ...
    account: "Account / platform (optional)",
    accountPlaceholder: "e.g. Alipay, IBKR",
  ...
  insights: {
    ...
    benchmark: {
      ...
      minOneRequired: "Keep at least one benchmark selected",
    ...
    risk: {
      ...
      betaLabel: "Beta (β) · sensitivity to benchmark",
      betaVs: "vs {{benchmark}}",
      betaLowConfidence: "limited data, for reference",
    ...
    attribution: {
      ...
      detailTitle: "Performance attribution",
      totalLabel: "Total P&L for the period",
      reconcileHint: "Sum of every holding's contribution below.",
      contributorsTitle: "Contributors",
      detractorsTitle: "Detractors",
      realizedTag: "Realized",
      info: "Breaks the period's total P&L into each holding's contribution (value change net of trades, plus dividends). Historical, for reference only.",
      disclaimer: "Based on historical contribution, for reference only — not investment advice.",
    },
    drawdown: {
      title: "Drawdown",
  ...
  portfolios: {
    ...
    insightTodayChange: "Today {{change}}",
    ...
    insightSetupTargets: "Set up targets",
    insightView: "View",
    insightViewActions: "View rebalancing",
    insightAdjustTargets: "Adjust targets",
    activeChip: "Active",
  ...
  import: {
    entryTitle: "Import data",
    title: "Import data",
    profileArcNative: "Arc (native format)",
    description:
    ...
    validRows_one: "{{count}} row ready to import",
    validRows_other: "{{count}} rows ready to import",
    invalidRows_one: "{{count}} row has errors (will be skipped)",
    invalidRows_other: "{{count}} rows have errors (will be skipped)",
    fileError: "File error: {{message}}",
    rowError: "Line {{line}}: {{errors}}",
    importButton: "Import {{count}} rows",
    importing: "Importing…",
    doneTitle: "Import complete",
    doneResult_one: "{{success}} transaction imported",
    doneResult_other: "{{success}} transactions imported",
    doneSkipped_one: "{{count}} row skipped",
    doneSkipped_other: "{{count}} rows skipped",
